...
namespace ScriptingLib
{
    public class InputManager
    {
        ...
        public bool SendInputs()
        {
            ...
            uint successfulInputs = Native.SendInput(len, inputList, Marshal.SizeOf(typeof(INPUT)));
        ...
        public void AddMouseMove(int x, int y)
        {
            ...
            input.Type = InputType.InputMouse;
            input.Data.Mouse = new MOUSEINPUT();
            input.Data.Mouse.dx = (int)Math.Ceiling((double)(x * 65535) / Native.GetSystemMetrics(SystemMetric.SM_CXSCREEN)) + 1;
            input.Data.Mouse.dy = (int)Math.Ceiling((double)(y * 65535) / Native.GetSystemMetrics(SystemMetric.SM_CYSCREEN)) + 1;
