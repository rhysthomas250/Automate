...
namespace ScriptingLib
{
    public class KeyboardHook : IDisposable
    {
        ...
        public KeyboardHook()
        {
            ...
            keyboardHookHandle = SetHook(Native.WH_KEYBOARD_LL, keyboardHookProc);
        }
        ...
        private IntPtr KeyboardHookProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            return Native.CallNextHookEx(keyboardHookHandle, nCode, wParam, lParam);
        }
        ...
        public void Dispose()
        {
            Native.UnhookWindowsHookEx(keyboardHookHandle);
        }
        ...
        private static IntPtr SetHook(int hookType, HookProc hookProc)
        {
            ...
            {
                return Native.SetWindowsHookEx(hookType, hookProc, Native.GetModuleHandle(currentModule.ModuleName), 0);
            }
        }
    }
}